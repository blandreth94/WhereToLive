  ...
  connectivity: {
    ...
    matrix: {
      roanoke: {
        ...
        slc:      { type: "connecting",                                                  summary: "Connecting flights required via major eastern hubs.",                             details: "Salt Lake City from Roanoke requires navigating a layover through major eastern hubs — typically Charlotte (CLT), Atlanta (ATL), or Chicago (ORD) — before connecting westward to SLC. No direct service exists. Total transit times typically range from 5–8 hours depending on connection quality.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        source: { name: "Google Flights (2026)",                                             url: "https://www.google.com/travel/flights" } },
        ...
        sna:      { type: "connecting",                                                  summary: "Connecting flights required via major legacy hubs.",                             details: "Accessing John Wayne Airport (SNA) in Orange County from Roanoke requires navigating transcontinental connections via United or American through hubs like Charlotte, Atlanta, or Chicago. No direct service exists. Total transit times typically run 6–9+ hours.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            source: { name: "United Airlines (2026)",                                            url: "https://www.united.com/en-us/flights-from-roanoke-to-orange-county" } },
        mco:      { type: "mixed",                                fare: "~$218 to MCO",  note: "Allegiant SFB nonstop ends Aug 2026",  summary: "Allegiant nonstop to Orlando Sanford (SFB) through Aug 2026; connecting to MCO (~$218).", details: "Roanoke offers a direct, nonstop flight to Orlando Sanford (SFB) via Allegiant Air, though scheduled data indicates this route may terminate in August 2026. Standard connecting flights to the primary Orlando International Airport (MCO) average $218 one-way. For surface transit, Amtrak operates a routing from Roanoke to Orlando that consumes 27 hours and 50 minutes at a cost of $199.",                                                                                                                                                                                                                                                                                                                                                                                                                                              source: { name: "FlightsFrom.com (ROA) / Expedia (2026)",                            url: "https://www.expedia.com/lp/flights/roa/mco/roanoke-to-orlando" } },
        crp:      { type: "connecting",                                                  summary: "Connecting flights required via DFW or IAH.",                                   details: "Corpus Christi (CRP) from Roanoke requires routing through DFW or Houston Intercontinental (IAH) on American or United. No direct service exists. The upcoming June 2026 ROA→DFW nonstop will improve this connection by eliminating one hop for Corpus Christi-bound travelers.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         source: { name: "American Airlines (2026)",                                          url: "https://www.aa.com/en-us/flights-to-corpus-christi" } },
        sfo:      { type: "connecting",                           fare: "$244–$314",     summary: "Connecting flights required — typically via United hubs (ORD or IAD).",          details: "Reaching San Francisco from Roanoke requires a layover, typically through United's hubs in Chicago (ORD) or Dulles (IAD), or via American Airlines. Fares exhibit high variability but baseline around $244 to $314 for economy. Total transit times typically run 6–9 hours.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             source: { name: "Expedia / United Airlines (2026)",                                  url: "https://www.expedia.com/lp/flights/roa/sfo/roanoke-to-san-francisco" } },
        anc:      { type: "connecting",                                                  summary: "Complex multi-hub routing required — 11 to 20+ hours.",                          details: "Traveling from Roanoke to Anchorage (ANC) involves complex, multi-hub routing across Delta, American, or United/Alaska codeshares. Total travel times range from a highly optimized 11 hours to grueling 20+ hour journeys involving two or three stops.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               source: { name: "FlightConnections (2026)",                                          url: "https://www.flightconnections.com/flights-from-roanoke-roa" } },
        ...
        rome:     { type: "connecting",                                                  summary: "Connecting flights required via major East Coast international gateways.",       details: "Traveling from Roanoke to Rome Fiumicino (FCO) requires a transatlantic connection via an eastern seaboard gateway — typically JFK, EWR, or IAD — before the transatlantic leg. No direct service exists from ROA to any European city.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 source: { name: "Expedia (2026)",                                                    url: "https://www.expedia.com/lp/flights/roa/tyo/roanoke-to-tokyo" } }
      },
      waldorf: {
        roanoke:  { type: "amtrak",                                                      summary: "Amtrak NE Regional from Union Station; or drive via I-81/US-29.",               details: "From Waldorf, reaching Roanoke is most efficiently done by driving the I-81 or US-29 corridors (approximately 100 miles, 1.5–2 hours in off-peak traffic), or via the Amtrak Northeast Regional departing from Union Station in D.C. (requires bus or taxi to Union Station first — 1h 10m, $4–$7 via MTA bus).",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            source: { name: "Amtrak / Rome2Rio (2026)",                                          url: "https://www.amtrak.com/northeast-regional-train" } },
        waldorf:  { type: "self" },
        denver:   { type: "direct",                                                      summary: "Nonstop via United, Frontier, and Southwest from DCA/IAD/BWI.",                 details: "Once Waldorf residents navigate ground transport to DCA, IAD, or BWI, direct nonstop flights to Denver operate on United, Frontier, and Southwest. Multi-carrier competition keeps fares competitive. Ground access from Waldorf to airports typically requires 60–120 minutes via MTA bus + Metro ($4–7 to DCA) or black car service ($158–$240 depending on airport).",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               source: { name: "FlightsFrom.com (DCA) (2026)",                                      url: "https://www.flightsfrom.com/DCA" } },
        ...
        fai:      { type: "connecting",                                                  summary: "Connecting flights required — via Seattle (SEA) or Chicago (ORD).",             details: "Fairbanks (FAI) is not accessible directly from any D.C. area airport. Passengers must connect through Seattle or Chicago, pushing travel times past 9 hours minimum.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  source: { name: "United Airlines (2026)",                                            url: "https://www.united.com/en-us/flights-from-washington-to-anchorage" } },
      ...
      denver: {
        roanoke:  { type: "connecting",                                                  summary: "Connecting flights via ORD or IAD required.",                                   details: "From Denver, accessing the regional spoke of Roanoke requires navigating a layover through a major eastern hub — typically Chicago (ORD) or Dulles (IAD). No direct service exists. The upcoming June 2026 AA nonstop is DFW→ROA, not DEN→ROA.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     source: { name: "Expedia (DEN→ROA) (2026)",                                          url: "https://www.expedia.com/lp/flights/roa/den/roanoke-to-denver" } },
        ...
        richmond: { type: "direct",                                                      summary: "Nonstop flights available to Richmond (RIC).",                                  details: "Denver provides direct, nonstop flights to Richmond International Airport (RIC) via legacy carriers. This provides convenient point-to-point access to the Richmond metro without routing through D.C.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               source: { name: "Denver International Airport Nonstop Routes (2026)",                url: "https://www.flydenver.com/nonstop-routes/" } },
      ...
      slc: {
        ...
        richmond: { type: "direct",                                                      summary: "Nonstop flights available to Richmond (RIC).",                                  details: "SLC provides direct, nonstop service to Richmond International Airport (RIC) via available carriers, making east coast Virginia travel accessible without a D.C. connection.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         source: { name: "FlightConnections (SLC) (2026)",                                    url: "https://www.flightconnections.com/flights-from-salt-lake-city-slc" } },
        nyc:      { type: "direct",                                                      summary: "Nonstop to LGA, JFK, and EWR via Delta and others.",                            details: "Salt Lake City provides direct, nonstop service into all three New York City metro airports — LaGuardia (LGA), JFK, and Newark (EWR) — primarily driven by Delta's hub operations. Competitive pricing exists despite Delta's dominant market position.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             source: { name: "FlightConnections (SLC) (2026)",                                    url: "https://www.flightconnections.com/flights-from-salt-lake-city-slc" } },
        ...
        crp:      { type: "connecting",                                                  summary: "Connecting flights required via Texas hubs.",                                   details: "Corpus Christi from SLC requires connecting flights through Texas hubs (DFW or IAH). No direct service exists.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   source: { name: "American Airlines (2026)",                                          url: "https://www.aa.com/en-us/flights-to-corpus-christi" } },
      ...
      raleigh: {
        ...
        waldorf:  { type: "direct",                                                      summary: "Nonstop to DCA/IAD via multiple carriers.",                                     details: "From RDU, direct, nonstop flights to the D.C. area (DCA and IAD) are available across multiple carriers. The Research Triangle's rapidly expanding hub infrastructure ensures competitive pricing and frequent departures for D.C. travel.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           source: { name: "RDU Airline Destinations (2026)",                                   url: "https://www.rdu.com/airline-information/airline-destinations/" } },
        ...
        sna:      { type: "upcoming",                              note: "Breeze Airways nonstop starts May 2026",  summary: "Breeze Airways nonstop starts May 2026. Legacy connections via CLT/DFW currently.", details: "Raleigh's access to Orange County is undergoing a fundamental change. Historically, reaching SNA from RDU required connecting flights through hubs like Charlotte or Dallas, costing between $433 and $997 round-trip. This changes in May 2026 when Breeze Airways inaugurates direct, nonstop service from RDU to SNA — a highly anticipated addition to the Research Triangle's growing LCC footprint.",                                                                                                                                                                                                                                                                                                                                                                                                                                                    source: { name: "RDU Airline Destinations (2026)",                                   url: "https://www.rdu.com/airline-information/airline-destinations/" } },
        ...
        tokyo:    { type: "connecting",                                                  summary: "Connecting via domestic hubs (DFW, ORD, EWR) required.",                       details: "RDU lacks any direct, nonstop Asian service. Travel to Tokyo requires routing passengers backward through domestic hubs like DFW, ORD, or EWR prior to the transpacific leg. RDU is rapidly expanding transatlantic service (Paris, London, Frankfurt, Dublin), but Asia Pacific remains connection-dependent.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         source: { name: "Air France / RDU (2026)",                                           url: "https://wwws.airfrance.us/en-us/flights-from-raleigh" } },
        rome:     { type: "connecting",                                                  summary: "Connecting via European alliance gateways.",                                    details: "RDU is rapidly expanding its transatlantic portfolio with direct flights to Paris, London, and Frankfurt, but lacks direct flights to Rome. Passengers must connect through European alliance gateways for FCO travel.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 source: { name: "Air France / RDU (2026)",                                           url: "https://wwws.airfrance.us/en-us/flights-from-raleigh" } }
      },
      dfw: {
        ...
        fai:      { type: "connecting", time: "7h 45m+",                                summary: "Connecting via SLC or Minneapolis (MSP) — 7h 45m+.",                            details: "Fairbanks (FAI) requires a connection from DFW, usually through Salt Lake City or Minneapolis, extending travel time to a minimum of 7 hours and 45 minutes.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         source: { name: "FlightConnections (DFW→FAI) (2026)",                                url: "https://www.flightconnections.com/flights-from-dfw-to-fai" } },
        tokyo:    { type: "direct",     time: "13h 5m",                                 summary: "Nonstop to Tokyo Haneda (HND) via AA and JAL — 13h 5m.",                        details: "As a oneworld alliance nexus, DFW provides massive direct lift across the Pacific. American Airlines and Japan Airlines (JAL) execute direct, nonstop flights bridging DFW and Tokyo Haneda (HND) in approximately 13 hours and 5 minutes.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            source: { name: "Trip.com (DFW→TYO) (2026)",                                         url: "https://www.trip.com/hot/flight-time-from-dallas-to-tokyo/" } },
    ...
    hubProfiles: {
      roanoke: {
        ...
        btsFare: null,
        btsFareNote: "Higher aggregate fares due to hub connection dependency; limited LCC competition",
        strengths: [
      ...
      waldorf: {
        ...
        btsFare: null,
        btsFareNote: "Competitive — BWI offers Southwest dominance; DCA and IAD provide legacy carrier frequency",
        strengths: [
      ...
      denver: {
        ...
        btsFare: "$363.47",
        btsFareNote: "One of the lowest average domestic fares in the U.S. — extreme LCC competition from United, Southwest, and Frontier",
        strengths: [
      ...
      slc: {
        ...
        btsFare: null,
        btsFareNote: "Legacy carrier yield premium expected; Delta dominance limits ultra-low-cost fare options vs. DEN",
        strengths: [
          "Nonstop to all 5 subject cities",
      ...
      raleigh: {
        ...
        btsFare: null,
        btsFareNote: "Highly competitive mid-tier pricing; Breeze and Frontier expansion moderating fares",
        strengths: [
          "Nonstop to all 5 subject cities",
        ...
        summary: "RDU is a rapidly expanding focus city ideal for East Coast-centric operations. Excellent Amtrak integration, growing LCC presence, and strong domestic reach. Transcontinental and Asia Pacific routes are where gaps emerge.",
      ...
      dfw: {
        ...
        btsFare: null,
        btsFareNote: "AA fortress hub premium at DFW; partially offset by Southwest dominance at DAL 10 min away",
        strengths: [
