  ...
  connectivity: {
    ...
    matrix: {
      ...
      waldorf: {
        ...
        tokyo:    { type: "direct",    time: "~14h 5m",          fare: "$956–$1,101 RT", summary: "Nonstop to Tokyo Haneda (HND) via United and ANA from IAD — ~14h 5m.",                    details: "Dulles International Airport (IAD) provides Waldorf residents with supreme intercontinental access. IAD boasts direct, nonstop service to Tokyo Haneda (HND) via United Airlines and ANA, circumventing the need for West Coast layovers. This nonstop route is one of the most operationally significant intercontinental links in this comparison.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    source: { name: "Dulles Airport Nonstop Destinations (2026)",                         url: "https://www.flydulles.com/nonstop-destinations" } },
      ...
      denver: {
        ...
        waldorf:  { type: "direct",     time: "~3h 21m",                                  summary: "Nonstop to IAD and DCA via United and Frontier — ~3h 21m.",                    details: "Direct, nonstop flights operate continuously from Denver to Washington D.C. via United to IAD and Frontier to DCA. Average direct flight time is approximately 3 hours 21 minutes. Multiple daily departures ensure scheduling flexibility for D.C.-area business or personal travel.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  source: { name: "Google Flights (DEN) (2026)",                                       url: "https://www.google.com/travel/flights/flights-from-denver.html" } },
        denver:   { type: "self" },
        slc:      { type: "direct",     time: "~1h 30m",          fare: "from $53 RT",   summary: "Nonstop via Southwest, Delta, Frontier, United — ~1h 30m, from $53 RT.",       details: "As a centrally located mega-hub, Denver provides effortless direct connectivity to Salt Lake City via Southwest, Delta, Frontier, and United. The 1.5-hour flight is one of the most competitive routes in the Mountain West corridor, with intense LCC saturation driving fares to extraordinary lows — round-trips frequently drop to $53.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   source: { name: "FlightsFrom.com (DEN) (2026)",                                      url: "https://www.flightsfrom.com/DEN" } },
        raleigh:  { type: "direct",     time: "~3h 47m",          fare: "$87–$280 RT",   summary: "Nonstop via Frontier, United, Southwest — ~3h 47m, $87–$280 RT.",              details: "Direct, nonstop service to Raleigh from Denver operates on Frontier, United, and Southwest, taking roughly 3 hours 47 minutes. Round-trip fares typically range from $87 to $280, with LCC competition keeping baseline pricing accessible.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        source: { name: "Google Flights (DEN→RDU) (2026)",                                   url: "https://www.google.com/travel/flights/flights-from-raleigh.html" } },
        dfw:      { type: "direct",     time: "~2h 9m",           fare: "$41+ OW / avg ~$450 RT", summary: "Nonstop to DFW and DAL via AA, Frontier, United, Southwest — ~2h 9m.",  details: "Flights to Dallas from Denver operate directly to both DFW and DAL via American, Frontier, United, and Southwest, with average flight times of approximately 2 hours 9 minutes. One-way tickets can start as low as $41, though average round-trips run near $450.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               source: { name: "Denver International Airport Nonstop Routes (2026)",                url: "https://www.flydenver.com/nonstop-routes/" } },
        ...
        crp:      { type: "direct",                                                       summary: "Frontier operates a direct nonstop to Corpus Christi (CRP) from DEN.",           details: "Frontier Airlines operates a direct, nonstop flight from Denver (DEN) to Corpus Christi (CRP), making Denver one of the only cities in this comparison with a direct line to the Texas Gulf Coast without a connection.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       source: { name: "Google Flights (DEN→CRP) (2026)",                                   url: "https://www.google.com/travel/flights" } },
        sfo:      { type: "direct",     time: "~2h 35m",          fare: "from $100 RT",  summary: "Nonstop via United, Southwest, Frontier — ~2h 35m, from $100 RT.",             details: "As a centrally positioned western hub, Denver serves as a primary logistical funnel for SFO traffic. United Airlines, Southwest, and Frontier provide immense direct, nonstop capacity in approximately 2 hours 35 minutes. Round-trip fares start around $100, with LCC competition driving down pricing structures.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           source: { name: "FlightsFrom.com (DEN) (2026)",                                      url: "https://www.flightsfrom.com/DEN" } },
        ...
        fai:      { type: "direct",     time: "5h 35m",           fare: "from $701 RT",  summary: "Nonstop via United — 5h 35m, from $701 RT. Denver is the ONLY subject city with a Fairbanks nonstop.", details: "Denver is uniquely positioned as the only subject city offering a direct, nonstop flight to Fairbanks (FAI). United Airlines operates this route, covering 2,423 miles in 5 hours and 35 minutes, with round-trip fares starting around $701. No other city in this comparison — not DFW, not SLC, not Raleigh — can reach Fairbanks without a connection.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  source: { name: "FlightConnections (DEN→FAI) (2026)",                                url: "https://www.flightconnections.com/flights-from-den-to-fai" } },
      ...
      slc: {
        roanoke:  { type: "connecting", time: "~7h 10m–9h 44m (1 stop)", fare: "$250–$310 RT", summary: "Connecting flights via major eastern hubs — ~7h 10m–9h 44m, $250–$310 RT.",  details: "Like Denver, accessing the regional spoke of Roanoke from Salt Lake City requires navigating a layover through a major eastern hub — typically Charlotte (CLT), Atlanta (ATL), or Chicago (ORD). No direct service exists. Total travel time ranges from roughly 7 to 10 hours with round-trip fares of $250–$310.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             source: { name: "Google Flights (2026)",                                             url: "https://www.google.com/travel/flights" } },
        ...
        denver:   { type: "direct",     time: "~1h 30m",          fare: "from $53 RT",   summary: "Nonstop via Delta, Frontier, Southwest, United — ~1h 30m, from $53 RT.",       details: "Direct, nonstop flights are scheduled to Denver from SLC via multiple carriers. The 1.5-hour flight is a high-frequency corridor in the Mountain West, with intense LCC competition driving round-trip fares as low as $53.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              source: { name: "FlightsFrom.com (DEN) (2026)",                                      url: "https://www.flightsfrom.com/DEN" } },
        slc:      { type: "self" },
        ...
        fai:      { type: "connecting", time: "~7h (1 stop)",      fare: "from $360 RT",  summary: "Connecting via SEA or ANC — ~7h (1 stop), from $360 RT.",                      details: "Unlike Denver, SLC currently lacks direct flights to Fairbanks. Passengers must connect through Seattle (SEA) or Anchorage (ANC), with best-case total travel time around 7 hours and round-trip fares starting near $360. This is SLC's only notable Alaska connectivity gap compared to Denver.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     source: { name: "Skyscanner (SLC→FAI) (2026)",                                       url: "https://www.skyscanner.com/routes/slc/fai/salt-lake-city-to-fairbanks-international.html" } },
      ...
      raleigh: {
        ...
        denver:   { type: "direct",     time: "~3h 47m",          fare: "from $87 RT",   summary: "Nonstop via Frontier, United, Southwest — ~3h 47m, from $87 RT.",              details: "From RDU, traveling to Denver is accomplished with ease via direct, nonstop service on Frontier, United, and Southwest in approximately 3 hours 47 minutes, with round-trip fares starting around $87. The Amtrak option (Raleigh to Denver) takes a grueling 44 hours and 54 minutes at $255 and effectively eliminates surface transit as a viable tool for western travel.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          source: { name: "RDU Airline Destinations (2026)",                                   url: "https://www.rdu.com/airline-information/airline-destinations/" } },
        ...
        sfo:      { type: "direct",     time: "~5h 42m",          fare: "from $309 RT",  summary: "Nonstop via United Airlines — ~5h 42m, from $309 RT.",                         details: "RDU has cultivated vital transcontinental links to support the Research Triangle's technology ecosystem. United Airlines operates a dedicated direct, nonstop flight bridging RDU directly into its SFO hub in approximately 5 hours 42 minutes, with round-trip fares starting around $309. High-yield corporate traffic bypasses mid-continent layovers.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         source: { name: "RDU Airline Destinations (2026)",                                   url: "https://www.rdu.com/airline-information/airline-destinations/" } },
        ...
        fai:      { type: "connecting", time: "~11h 8m–33h",       fare: "from $213 OW",  summary: "Connecting flights — ~11h 8m to 33h total, from $213 OW.",                      details: "Flights to Fairbanks from RDU take between approximately 11 hours 8 minutes and 33 hours depending on the routing matrix chosen. One-way fares start around $213. RDU completely lacks direct, nonstop capability to FAI, and the multi-connection penalty is among the more severe in this comparison.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             source: { name: "FlightConnections (RDU→FAI) (2026)",                                url: "https://www.flightconnections.com/flights-from-rdu-to-fai" } },
      ...
      dfw: {
        ...
        sfo:      { type: "direct",     time: "~3h 22m–3h 45m",                          summary: "Nonstop via AA from DFW and Southwest from DAL — ~3h 22m–3h 45m.",             details: "Dallas-Fort Worth ensures SFO is heavily saturated with direct, nonstop lift from both American Airlines out of DFW and Southwest Airlines from DAL. Flight times range from approximately 3 hours 22 minutes to 3 hours 45 minutes. Dual-airport access to SFO provides scheduling and fare flexibility.",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                source: { name: "FlightsFrom.com (DFW) (2026)",                                      url: "https://www.flightsfrom.com/DFW" } },
        ...
        rome:     { type: "direct",    time: "~10h 10m",          fare: "from $812 RT",  summary: "Nonstop via American Airlines — ~10h 10m, from $812 RT.",                      details: "DFW offers reliable year-round and seasonal direct, nonstop lift to Rome Fiumicino (FCO) via American Airlines in approximately 10 hours 10 minutes. Round-trip fares start around $812. DFW is one of only two subject cities with a direct Rome connection (alongside Waldorf/IAD and the upcoming Denver FCO service).",                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  source: { name: "Google Flights (DFW→ROM) (2026)",                                   url: "https://www.google.com/travel/flights/flights-from-dallas-to-rome.html" } }
      }
    },
